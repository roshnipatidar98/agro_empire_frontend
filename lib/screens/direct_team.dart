...
class DirectTeam extends StatefulWidget {
  const DirectTeam({Key? key}) : super(key: key);
...
class _DirectTeamState extends State<DirectTeam> {
  ...
  List<Teammodal> teamlist = [];
   ...
   Future<List<Teammodal>> getDirectTeam() async{


     var response = await CallApi().getData('/directTeam/');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Center(child: Text('Direct Team')),
      ),
